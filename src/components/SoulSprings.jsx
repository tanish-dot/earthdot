    ...
    <section id="soul-springs" ref={sectionRef} className="relative bg-void overflow-hidden">
      ...
      >
        <div className="absolute bottom-12 left-8 md:left-16 max-w-lg">
          ...
          <p className="font-serif text-ivory text-2xl md:text-3xl font-light italic leading-snug">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-0 mt-2">
        <div className="flex flex-col justify-center px-10 md:px-16 py-16 bg-void gap-10 order-2 md:order-1">
          ...
          <motion.p className="font-serif text-stone-grey text-base font-light leading-relaxed"
            ...
            Located at Sadanahalli, Soul Springs sits between the existing Isha Foundation and proposed ISKCON Foundation — part of a broader global spiritual continuum that resonates with consciousness and inner balance. The land rests within a cradle of hills: an inward-folding valley surrounded by gentle mountains.
          </motion.p>
      ...
      {/* ── FULL BLEED: water ripple reflection ── */}
      ...
      {/* ── SPLIT: stream life + closing image ── */}
      <div className="grid grid-cols-1 md:grid-cols-5 gap-2">
        ...
        <div className="md:col-span-2 bg-void flex flex-col justify-center px-10 py-16 gap-10">
          ...
          <motion.div className="flex flex-col gap-4"
            initial={{ opacity: 0 }} animate={{ opacity: inView ? 1 : 0 }} transition={{ delay: 0.5, duration: 1 }}>
            {['INTROSPECTION', 'SPIRITUALITY', 'COMMUNITY'].map((w, i) => (
      ...
      {/* ── CLOSING FULL BLEED ── */}
      <FullBleedImage src="/images/ss/ss-002.jpg" alt="Mossy stone steps with wildflowers" height="65vh" inView={inView} delay={0.1}>
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-8 z-10"
