...
export default function FloatingEnquire() {
  ...
  return (
    <AnimatePresence>
      {!hidden && (
        <motion.div
          className="fixed bottom-6 right-5 md:bottom-8 md:right-8 z-[200] flex flex-col items-end gap-3"
        ...
        >
          ...
          <a
            ...
            className="group flex items-center justify-center w-11 h-11 md:w-12 md:h-12 bg-[#25D366] text-white rounded-full shadow-[0_4px_20px_rgba(0,0,0,0.4)] hover:shadow-[0_6px_30px_rgba(37,211,102,0.3)] transition-all duration-500 hover:scale-105"
