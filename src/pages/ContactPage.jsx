          ...
          <div className="flex flex-col gap-14">
            ...
            <div>
              ...
              <div className="flex flex-col gap-4">
                ...
                <a href="https://www.reddit.com/u/The_EarthProject" target="_blank" rel="noopener noreferrer"
                  className="text-stone-grey hover:text-ivory transition-colors duration-500" aria-label="Reddit">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
